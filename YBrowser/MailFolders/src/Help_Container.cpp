...
void CMyHelpContainer::AddTextToEditorL()
{
	if (iRichMessageMe)
	{	
        HBufC* line1 = StringLoader::LoadLC(R_STR_MFHELP1);
        ...
        HBufC* line2 = StringLoader::LoadLC(R_STR_MFHELP2);
        ...
        HBufC* line3 = StringLoader::LoadLC(R_STR_MFHELP3);
        ...
        HBufC* line4 = StringLoader::LoadLC(R_STR_MFHELP4);
