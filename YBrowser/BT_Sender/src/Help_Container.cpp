...
void CMyHelpContainer::AddTextToEditorL()
{
	if (iRichMessageMe)
	{	
        HBufC* line1 = StringLoader::LoadLC(R_STR_BTHELP1);
        ...
        HBufC* line2 = StringLoader::LoadLC(R_STR_BTHELP2);
        ...
        HBufC* line3 = StringLoader::LoadLC(R_STR_BTHELP3);
        ...
        HBufC* line4 = StringLoader::LoadLC(R_STR_BTHELP4);
