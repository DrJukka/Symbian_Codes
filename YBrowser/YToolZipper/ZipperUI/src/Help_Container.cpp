...
void CMyHelpContainer::AddTextToEditorL()
{
	if (iRichMessageMe)
	{	
        HBufC* line1 = StringLoader::LoadLC(R_STR_ZIHELP1);
        ...
        HBufC* line2 = StringLoader::LoadLC(R_STR_ZIHELP2);
        ...
        HBufC* line3 = StringLoader::LoadLC(R_STR_ZIHELP3);
        ...
        HBufC* line4 = StringLoader::LoadLC(R_STR_ZIHELP4);
