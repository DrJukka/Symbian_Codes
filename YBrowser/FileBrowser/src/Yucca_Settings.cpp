...
CAknSettingItem* CAknYuccaSettingsListListbox::CreateSettingItemL(TInt aIdentifier)
{
	...
	case EEYSetFullScreen:
		...
		break;
    case EFolderPathScroll:
        settingItem = new (ELeave) CAknBinaryPopupSettingItem(aIdentifier,iSettings.iPathScroll);
        break;		
	}
...
void CYuccaSettings::CreateListBoxL(TSettingsItem aSettings)
{
    ...
    else
    {
    	...
    	iListBox->iSettings.iPathScroll     = aSettings.iPathScroll; 
...
void CYuccaSettings::GetValuesL(TSettingsItem& aSettings)
{
	if(iListBox)
	{
		...
		aSettings.iPathScroll = iListBox->iSettings.iPathScroll;
	...
	{
        aSettings.iPathScroll = iSettings.iPathScroll;
