...
-----------------------------------------------------------------------------
*/
CYuccaNavi* CYuccaNavi::NewL(const TBool& aScrroll)
    {
    CYuccaNavi* self = new(ELeave)CYuccaNavi(aScrroll);
	self->ConstructL();
    return self;
    }
/*
...
-----------------------------------------------------------------------------
*/
CYuccaNavi::CYuccaNavi(const TBool& aScrroll):iScrroll(aScrroll)
    {
    }
/*
-----------------------------------------------------------------------------
...
-----------------------------------------------------------------------------
*/
void CYuccaNavi::SetScroll(const TBool& aScrroll)
{
    iScrroll = aScrroll;
}
/*
 	...
 	if(iNaviDecorator)
	{
		if(iNaviDecorator->DecoratedControl())
		{
			...
			if(iFullText)
			{
				...
				if(CharCnt < iFullText->Des().Length() && iScrroll)
				{
