...
const TInt SClientServerRanges[SClientServerRangeCount] = 
        ...
        2, // 19-23 	; EExamplePServSetValue & EExamplePServSetValueAndName
        3, // 24-25 	; EExamplePServDeleteItem & EGetItemListItem
        4  // 26 up 	; non implemented function end of range check ; ENotSupported
        }; 
...
const TUint8 SClientServerElementsIndex[SClientServerRangeCount] = 
        ...
        CPolicyServer::EAlwaysPass, //i.e EExamplePServReadValueAndName
        CPolicyServer::EAlwaysPass,  //i.e EExamplePServSetValue & EExamplePServSetValueAndName
        CPolicyServer::EAlwaysPass,  //applies to 3rd range i.e. EExamplePServDeleteItem & EGetItemListItem
