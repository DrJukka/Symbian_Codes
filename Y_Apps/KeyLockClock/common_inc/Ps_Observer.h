...
{
public:
	virtual void PsValueChangedL(const TUid& aCategory, const TUint aKey,TInt aValue,TInt aError)=0;
	virtual void PsValueChangedL(const TUid& aCategory, const TUint aKey,const TDesC8& aValue,TInt aError)=0;
};
