...
#ifndef __FAKESMSSENDER__
#define __FAKESMSSENDER__
...
public : 
    ...
    ~CFakeSMSSender();
    void CreateSMSMessageL(HBufC* aNunmber,HBufC* aName,HBufC* aMessage,TBool aUnicodeMsg,TTime aMsgTime);
protected:
