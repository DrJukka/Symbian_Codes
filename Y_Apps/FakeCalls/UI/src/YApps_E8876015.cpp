...
#include "YApps_E8876015.hrh"                     // own definitions
#include "YApps_E8876015.h"                   // own resource header
...
void CMgAppUi::TimerExpired(void)
{
    if(iOkToContinue)
    {
        ...
        iMainContainer = new(ELeave)CMainContainer(Cba(),dimPreview);
