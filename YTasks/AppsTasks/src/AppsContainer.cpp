...
-----------------------------------------------------------------------------
*/
CMainListView* CMainListView::NewL(void)
    {
    CMainListView* self = CMainListView::NewLC();
...
-----------------------------------------------------------------------------
*/
CMainListView* CMainListView::NewLC(void)
    {
    CMainListView* self = new (ELeave) CMainListView();
...
-----------------------------------------------------------------------------
*/
HBufC* CMainListView::GetApplicationInfoL(TDes& aTitle)
{
	HBufC* Ret(NULL);
	if(iListBox && iAppUIDs)
	{
		...
		{	
			Ret= GetApplicationInfoLC(iAppUIDs->At(Curr),aTitle);
