...
#ifndef __APPSCONTAINER_H__
#define __APPSCONTAINER_H__
...
class CMainListView : public CCoeControl
    {
public:
    static CMainListView* NewL(void);
    static CMainListView* NewLC(void);
     ~CMainListView();
    void MakeListBoxL();
public:  // from CCoeControl
	HBufC* GetApplicationInfoL(TDes& aTitle);
