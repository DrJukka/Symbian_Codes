...
_LIT(KMyResourceFileName	,"\\resource\\apps\\YTools_A000312C_res.RSC");
_LIT(KtxIconsFileName		,"\\system\\data\\A000257B\\A000312C\\icons.mif");


_LIT(KtxApplicationName		,"Empty");
